...
ALERTS[CHECK_ENGINES] = {
  ...
  message: (
    ...
    return chalk().yellow(`a version ${options.engines.node} is required, ${currentVersion} is not suitable`)
  },
...
ALERTS[DAYS_OLD] = {
  ...
  message: (
    ...
    return chalk().yellow(`${currentVersion} is more than ${options[DAYS_OLD]} days old`)
  },
